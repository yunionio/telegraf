...
func (n niRsrcMon) SampleConfig() string {
	return `
  ## Optional: path to ni_rsrc_mon binary, defaults to $PATH via exec.LookPath
  # bin_path = "/usr/bin/ni_rsrc_mon"
...
func (n niRsrcMon) Description() string {
	return "Pull statistics from netint devices"
}
